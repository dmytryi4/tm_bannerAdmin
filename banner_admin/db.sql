...
--
-- Хост: 127.0.0.1
-- Время создания: Апр 19 2015 г., 23:03
...
(120, 'banner120', 1, 320, 250, 'block', '<img src="https://encrypted-tbn3.gstatic.com/images?q=tbn:ANd9GcSJpubtIj06mIReOv0HQg4pMPh_Rp93CyB0xao3nGP2B_uNeQje" title="??????">'),
(121, 'banner_new', 1, 1170, 520, 'block', '<img src="http://demiart.ru/forum/uploads5/post-140144-1270552474.jpg">'),
(126, 'banner_cat', 1, 353, 260, 'block', '<img src="https://www.it-tv.org/img/main_inet.jpg">'),
(128, 'banner_code', 1, 1170, 100, 'block', '<code>function hello(){alert("Hello world!"};</code>'),
